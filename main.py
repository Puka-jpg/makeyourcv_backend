...
from routes.user_input_routes.custom_section_routes import router as custom_section_routes
...
from routes.user_input_routes.technical_skill_routes import router as technical_skill_routes
