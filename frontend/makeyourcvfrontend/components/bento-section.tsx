  ...
  const cards = [
    {
      ...
      description: "Store your complete professional profile securely.",
      Component: AiCodeReviews,
    },
    {
      title: "Paste job descriptions.",
      description: "Add any job posting and let AI analyze the requirements.",
      Component: RealtimeCodingPreviews,
    },
    {
      title: "Get tailored CVs instantly.",
      description: "Download perfectly matched CVs optimized for each role.",
        ...
        <div className="self-stretch py-8 md:py-14 flex flex-col justify-center items-center gap-2 z-10">
          <div className="flex flex-col justify-start items-center gap-4">
            ...
            <p className="w-full max-w-[600px] text-center text-muted-foreground text-lg md:text-xl font-medium leading-relaxed">
              Simple, fast, and powered by AI to match your skills with the perfect job.
            </p>
          </div>
        </div>
